...
.about-hero {
  background: linear-gradient(135deg, rgba(88, 166, 255, 0.1) 0%, rgba(13, 17, 23, 0.9) 100%);
  padding: 60px 40px;
...
.lab-info {
  ...
  .info-row {
    ...
    .value { color: var(--text-color); font-family: monospace; }
  }
}
</style>
